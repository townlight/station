...
- Protocol 1.1 adds identity-bound asset loading, asset take, fallback return, and durable asset-loaded/on-air events without changing the framing contract.
