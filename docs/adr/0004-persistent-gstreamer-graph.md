...
This slice is intentionally not a complete playout engine. It has synthetic A/V sources and one UDP sink. Schedule-driven file decode, live ingest, canonical broadcast profiles, multi-sink fanout, captions, loudness, CG, recovery, and long-duration/three-channel proof remain required before release claims.
